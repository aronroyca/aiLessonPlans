...
const openaiCall = async function (req, res) {
  ...
  function generatePrompt(topic, grade, length, stateCurr) {
    return `Please create a ${length} hour lesson plan for ${grade} about ${topic}, which abides by ${stateCurr} curriculum standards. Use Madeline Hunter's template. Please format the document using html5.`;
